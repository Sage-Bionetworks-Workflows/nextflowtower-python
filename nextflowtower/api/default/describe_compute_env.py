...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DescribeComputeEnvResponse, ErrorResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DescribeComputeEnvResponse, ErrorResponse]]:
    return Response(
