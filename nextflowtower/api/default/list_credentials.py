...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ErrorResponse, ListCredentialsResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ErrorResponse, ListCredentialsResponse]]:
    return Response(
