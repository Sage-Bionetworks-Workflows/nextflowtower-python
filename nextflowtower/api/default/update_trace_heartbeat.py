...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/trace/{workflowId}/heartbeat".format(client.base_url, workflowId=workflow_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ErrorResponse, TraceHeartbeatResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ErrorResponse, TraceHeartbeatResponse]]:
    return Response(
