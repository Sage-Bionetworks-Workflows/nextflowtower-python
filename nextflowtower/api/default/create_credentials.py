...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, CreateCredentialsResponse, ErrorResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, CreateCredentialsResponse, ErrorResponse]]:
    return Response(
