...
def _get_kwargs(
    *,
    ...
    url = "{}/actions/types".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ErrorResponse, ListEventTypesResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ErrorResponse, ListEventTypesResponse]]:
    return Response(
