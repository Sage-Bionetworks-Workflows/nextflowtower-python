...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/workflow/{workflowId}/progress".format(client.base_url, workflowId=workflow_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ErrorResponse, GetProgressResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ErrorResponse, GetProgressResponse]]:
    return Response(
