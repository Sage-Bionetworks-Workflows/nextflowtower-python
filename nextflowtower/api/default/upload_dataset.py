...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ErrorResponse, UploadDatasetVersionResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ErrorResponse, UploadDatasetVersionResponse]]:
    return Response(
