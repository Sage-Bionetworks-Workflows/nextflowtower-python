...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DescribeDatasetResponse, ErrorResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DescribeDatasetResponse, ErrorResponse]]:
    return Response(
