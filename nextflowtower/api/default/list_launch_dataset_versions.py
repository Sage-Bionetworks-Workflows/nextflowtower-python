...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DescribeLaunchResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DescribeLaunchResponse]]:
    return Response(
