...
class ComputeEnv:
    ...
    Attributes:
        ...
        config (Union[AWSBatchConfiguration, AltairPBSConfiguration, AmazonEKSClusterConfiguration,
            AzureBatchConfiguration, GoogleGKEClusterConfiguration, GoogleLifeSciencesConfiguration, IBMLSFConfiguration,
            KubernetesComputeConfiguration, SlurmConfiguration, UnivaGridEngineConfiguration]):
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        compute_env.additional_properties = d
        return compute_env
