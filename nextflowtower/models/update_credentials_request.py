...
T = TypeVar("T", bound="UpdateCredentialsRequest")
...
class UpdateCredentialsRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_credentials_request = cls(
            credentials=credentials,
        )

        update_credentials_request.additional_properties = d
        return update_credentials_request
