...
T = TypeVar("T", bound="DescribePipelineResponse")
...
class DescribePipelineResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        describe_pipeline_response = cls(
            pipeline=pipeline,
        )

        describe_pipeline_response.additional_properties = d
        return describe_pipeline_response
