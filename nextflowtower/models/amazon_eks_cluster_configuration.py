...
T = TypeVar("T", bound="AmazonEKSClusterConfiguration")


@attr.s(auto_attribs=True)
class AmazonEKSClusterConfiguration:
    """
    Attributes:
        ...
        region (Union[Unset, str]): AWS region
        cluster_name (Union[Unset, str]): The AWS EKS cluster name
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amazon_eks_cluster_configuration = cls(
            work_dir=work_dir,
        ...
        amazon_eks_cluster_configuration.additional_properties = d
        return amazon_eks_cluster_configuration
