...
T = TypeVar("T", bound="AltairPBSConfiguration")


@attr.s(auto_attribs=True)
class AltairPBSConfiguration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        altair_pbs_configuration.additional_properties = d
        return altair_pbs_configuration
